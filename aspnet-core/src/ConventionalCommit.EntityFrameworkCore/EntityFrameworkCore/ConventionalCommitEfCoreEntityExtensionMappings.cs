...
{
    public static class ConventionalCommitEfCoreEntityExtensionMappings
    {
        ...
        public static void Configure()
        {
            ...
            OneTimeRunner.Run(() =>
            {
                 ...
                 * USE ConventionalCommitModuleExtensionConfigurator CLASS (in the Domain.Shared project)
