...
namespace ConventionalCommit.Users
{
    ...
    public class AppUser : FullAuditedAggregateRoot<Guid>, IUser
    {
         ...
         *
         * 1. Update ConventionalCommitDbContext.OnModelCreating
         * to configure the mapping for your new property
         * 2. Update ConventionalCommitEfCoreEntityExtensionMappings to extend the IdentityUser entity
